        ...
        <div className="space-y-8 pb-10 max-w-3xl">
            ...
            <Card className="bg-card border-border">
                ...
                <CardContent className="space-y-6">
                    ...
                    {/* Industry Focus */}
                    <div className="space-y-2">
                        <Label htmlFor="industry_focus" className="text-foreground">
                            Industry Focus
                        </Label>
                        <Input
                            id="industry_focus"
                    ...
                    {/* Services */}
                    <div className="space-y-2">
                        <Label htmlFor="services" className="text-foreground">
                            Services / Products
                        </Label>
                        <Input
                            id="services"
                    ...
                    {/* Example Format */}
                    <div className="space-y-2">
                        <Label htmlFor="example_format" className="text-foreground">
                            Desired JSON Brand/Format <span className="text-primary">*</span>
                        </Label>
                        <Textarea
                            id="example_format"
                            placeholder='{"icebreaker":"Hey {name}, \n\n really respect X and love that you’re doing Y. Wanted to run something by you"}'
                            className="min-h-[80px] bg-muted border-border font-mono text-xs"
                    ...
                    <div className="space-y-3 pt-4 border-t border-border">
                        ...
                        {context.good_examples.length === 0 && (
                            <div className="bg-muted border border-border rounded-lg p-4 text-center">
                                <p className="text-sm text-muted-foreground">No good examples yet. Click "Add Example" to provide samples.</p>
                            </div>
                        )}
                        {context.good_examples.map((example, index) => (
                            <div key={index} className="flex gap-2">
                                <Textarea
                                    ...
                                    className="flex-1 bg-muted border-border min-h-[80px]"
                                    value={example}
                    ...
                    <div className="space-y-3 pt-4 border-t border-border">
                        ...
                        {context.bad_examples.length === 0 && (
                            <div className="bg-muted border border-border rounded-lg p-4 text-center">
                                <p className="text-sm text-muted-foreground">No bad examples yet. Optional but recommended for better results.</p>
                            </div>
                        )}
            ...
            <Card className="bg-card border-border">
                ...
                <CardContent className="space-y-4">
                    ...
                    <div>
                        ...
                        <div className="bg-muted p-4 rounded-lg border border-border font-mono text-xs text-primary">
