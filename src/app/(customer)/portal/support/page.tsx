            ...
            <div className="max-w-2xl mx-auto space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-foreground/50">We're here to help</p>
                    </div>
                </div>
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-3">
                <Card className="bg-foreground/[0.02] border-foreground/5 hover:border-primary/30 transition-colors">
                    <CardContent className="p-4 text-center space-y-2">
                        ...
                        <p className="text-xs text-foreground/40">support@mailsmith.co</p>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-foreground/[0.02] border-foreground/5 hover:border-primary/30 transition-colors">
                    <CardContent className="p-4 text-center space-y-2">
                        ...
                        <h3 className="font-medium text-foreground text-sm">Call Us</h3>
                        <p className="text-xs text-foreground/40">+1 (555) 123-4567</p>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-foreground/[0.02] border-foreground/5 hover:border-primary/30 transition-colors">
                    <CardContent className="p-4 text-center space-y-2">
                        ...
                        <p className="text-xs text-foreground/40">Within 24 hours</p>
                    </CardContent>
                </Card>
            </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                ...
                                rows={5}
                                className="bg-foreground/5 border-foreground/10 text-foreground placeholder:text-foreground/30 resize-none"
                                required
                            />
                        </div>
                ...
                <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-sm font-medium text-foreground">Need quick answers?</p>
                                <p className="text-xs text-foreground/40">Check out our help documentation</p>
                            </div>
                        </div>
                        <Button variant="outline" size="sm" className="text-foreground/60 border-foreground/10 hover:text-foreground">
                            View Docs
                        </Button>
                    </div>
                </CardContent>
